# Generated by Django 3.2.12 on 2022-03-02 15:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', restaurant.models.RestaurantManager()),
            ],
        ),
        migrations.CreateModel(
            name='Menu',
            fields=[
                ...
                ('restaurant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='restaurant', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('-created_at',),
                'abstract': False,
